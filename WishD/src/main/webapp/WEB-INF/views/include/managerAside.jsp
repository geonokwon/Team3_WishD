...
<!-- 관리자 메뉴 -->
  <div class="flex-shrink-0 p-3" style="width: 280px;">
    <a href="${pageContext.request.contextPath}/manager/managerMain" class="d-flex align-items-center pb-3 mb-3 link-body-emphasis text-decoration-none border-bottom">
      ...
      <li class="mb-1">
        ...
        <div class="collapse show" id="home-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            ...
            <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded">기술 추가</a></li>
          </ul>
        </div>
      </li>
      <li class="mb-1">
        ...
        <div class="collapse show" id="dashboard-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li><a href="${pageContext.request.contextPath}/qna" class="link-body-emphasis d-inline-flex text-decoration-none rounded">QnA 게시판</a></li>
            <li><a href="${pageContext.request.contextPath}/community" class="link-body-emphasis d-inline-flex text-decoration-none rounded">공지사항</a></li>
          </ul>
        </div>
      </li>
      <li class="mb-1">
        ...
        <div class="collapse show" id="orders-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            ...
            <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded">관리자 계정 관리</a></li>
          </ul>
        </div>
      </li>
