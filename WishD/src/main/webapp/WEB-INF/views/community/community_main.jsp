...
<head>
    ...
    <script
            ...
            crossorigin="anonymous"
    ></script>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/community/communitycss.css">
...
<div class="container-fluid">
        ...
        <div class="horizontal-sections">
            ...
            <div class="col-8 section">
                <p class="headtext">
                    ...
                    <br>it doesn't steal my beer.
                </p>
            </div>

            <div class="col-2 section introtext">
                <span class="" style="color: rgb(119, 121, 169);">the developers</span> that are connected now
            </div>
        </div>
    </div>
    ...
    <div class="custom-section-1 d-flex flex-column">
        ...
        <!-- 공지 테이블 -->
            ...
            <div class="col-2 section introtext">
                <span class="" style="color: rgb(119, 121, 169);">Search</span>
            </div>
        </div>
    </div>
    ...
    <div class="custom-section-2 d-flex flex-column">
        ...
        <!-- QnA 테이블 -->
            ...
            <div class="col-2 section introtext">
                <span class="" style="color: rgb(119, 121, 169);">Write</span>
            </div>
        </div>
    </div>
