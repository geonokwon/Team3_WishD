                    ...
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <input type="text"
                                   ...
                                   autocomplete="off"
                                   value="${myProjectDTO.pboard_money}"
                                   required
                            />
                        </div>
...
<%--                     	value="${myprojectDTO.pboard_startDate}" --%>
                    ...
                    <div class="row align-items-center">
                        <div class="col-5">
                            <input type="text"
                                   ...
                                   placeholder="개월 수"
                                   autocomplete="off"
                                   value="${myProjectDTO.pboard_rangeMonth}"
                                   required
                            />
                        </div>
                        <div class="col-auto ms-2">
                ...
                <div class="row container mt-5 px-5 justify-content-center">
                    <button type="button" class="col-4 me-3 btn btn-primary" data-bs-toggle="modal" data-bs-target="#agreeSave">수정하기</button>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content bg-primary ps-2 pt-2">
                            <div class="modal-header">
                                <h1 class="modal-title fs-6" id="agreeTitle">현재 상태로 수정하시겠습니까?</h1>
                            </div>
